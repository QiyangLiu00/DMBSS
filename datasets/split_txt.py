...
class SplitFiles():
    ...
    def get_random(self):
        ...
        random_num = random.sample(range(1, 30400), 6080)
    ...
    def get_part_file_name(self, part_name):
        ...
        part_file_name = temp_path + "/PatternNet_" + str(part_name) + "_list.txt"
...
if __name__ == "__main__":
    file = SplitFiles(r"../Data/PatternNet/PatternNet.txt")
    file.split_file()
